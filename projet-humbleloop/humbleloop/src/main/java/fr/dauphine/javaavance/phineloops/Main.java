	...
	public static void main(String[] args) {
		...
		try {
			if (cmd.hasOption("g")) {
				...
				SquareGrid squareGrid = new SquareGrid(width, height);
				Generator<Square> generator = new Generator<>(outputFile);
				generator.generate(squareGrid, height, width);
				...
				SquareGrid squareGrid = new SquareGrid(inputFile);
				BasicSolver<Square> solver = new BasicSolver<>(squareGrid, outputFile);
				solved = solver.solve();
				...
				SquareGrid squareGrid = new SquareGrid(inputFile);
				Checker checker = new Checker(squareGrid);
				solved = checker.check();
